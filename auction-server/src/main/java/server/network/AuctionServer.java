...
public class AuctionServer {
    private static final int PORT=2810; //tạo 1 cổng để kết nối tới server
    public static List<ClientHandler> clients = new CopyOnWriteArrayList<>(); // list quản lí các kết nối của người dùng
    public static void main(String[] args){
        DatabaseConnection.getInstance().getConnection();   //kết nối tới Database
        System.out.println("[HỆ THỐNG] Đã mở Database thành công!");
        try (ServerSocket serverSocket = new ServerSocket(PORT)){ //tạo socket
            ...
            while (true) {
                ...
                //Thêm dữ liệu của khách hàng vào danh sách
